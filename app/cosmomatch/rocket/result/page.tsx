// app/rocket-match/result/page.tsx
"use client"
...
import { Award, ArrowRight, RefreshCw, BookOpen, Star, Sparkles, ChevronRight } from "lucide-react"
    ...
    <ContentPageLayout title="診断結果" level={1} levelTitle="" logo="CBtype">
      <div className="max-w-3xl mx-auto pb-16 animate-in fade-in zoom-in-95 duration-500">
          ...
          <div className="mb-12">
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              {otherCandidates.map((cand) => (
                <Link key={cand.slug} href={`/rocket-match/result?rocket=${cand.slug}`} className="block group">
        ...
        <div className="border-t border-border/50 pt-8 flex flex-col sm:flex-row gap-4 justify-center">
          <Link href={`/rocket-match/dictionary/${rocket.slug}`} className="w-full sm:w-auto">
          ...
          <Link href="/rocket-match" className="w-full sm:w-auto">
